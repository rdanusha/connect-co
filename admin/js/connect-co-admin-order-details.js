(function ($) {
    ...
    $(function () {
                ...
                success: function (response) {
                    if (response) {
                        ...
                        if (response.status == 'success') {
                            ...
                            $('#cc_delivery_charge').val(response.value);
        ...
        function cc_is_order_submitted() {
            ...
            $.ajax({
                ...
                type: 'post',
                data: {
                    'action': 'check_is_order_submitted',
                    'ajax': true,
                    'nonce': connect_co_ajax.nonce,
                    'order_id': order_id,
                },
        ...
        $("#connect-co-submit").click(function (e) {
            ...
            if (confirmation) {
                ...
                let cc_city = $('#cc_city option:selected').val();
                let order_id = $('#cc_order_id').val();
                let cc_delivery_charge = $('#cc_delivery_charge').val();
        ...
        $('#cc-show_details').on('click', function () {
            $('.cc-form-fields').toggleClass('cc-hide-records');
